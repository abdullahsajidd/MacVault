import { ArrowRight, Gamepad2, Headphones, Laptop, MessageCircle, PackageSearch, Search, Smartphone, Tablet, Watch as WatchIcon, type LucideIcon } from "lucide-react";
